...
namespace LaCatalanaWeb.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public EmpresasController(GEAContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEmpresa,NombreEmpresa")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmpresa,NombreEmpresa")] Empresa empresa)
        {
